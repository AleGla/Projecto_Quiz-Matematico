...
<html>
    ...
    <body>
                ...
                <div class="container">
                    <div class="row align-items-start">
                        ...
                        <div class="col">
                            ...
                            <h3><i class="bi bi-question-circle" style="color: blue"></i> Pregunta 5/10</h3>
        ...
        <jsp:include page="/WEB-INF/content/hard/multiplied/correct/correct5.jsp"/>
        <jsp:include page="/WEB-INF/content/hard/multiplied/incorrect/incorrect5.jsp"/>
