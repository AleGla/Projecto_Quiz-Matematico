...
<html>
    ...
    <body>
                ...
                <div class="container">
                    <div class="row align-items-start">
                        ...
                        <div class="col">
                            ...
                            <h3><i class="bi bi-question-circle" style="color: blue"></i> Pregunta 6/10</h3>
        ...
        <div class="d-grid gap-2 col-6 mx-auto">
            ...
            <br/>
            <a data-toggle="modal" data-target="#modal" data-backdrop="static" data-keyboard="false"><button class="btn btn-primary btn-block btn-huge" style="font-size: 25px"><s:property value="numbers.choiseNumber2"/></button></a>
            <br/>
        ...
        <jsp:include page="/WEB-INF/content/hard/multiplied/correct/correct6.jsp"/>
        <jsp:include page="/WEB-INF/content/hard/multiplied/incorrect/incorrect6.jsp"/>
