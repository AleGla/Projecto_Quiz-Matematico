...
<html>
    <head>
        ...
        <title>Operaciones de Multiplicaciones</title>
    ...
    <body>
            ...
            <div class="jumbotron text-center" >
                <div class="container">
                    <div class="row align-items-start">
                        ...
                        <div class="col">
                            <h1 style="font-size: 41px"><s:property value="numbers.number"/> * <s:property value="numbers.numberTwo"/> = ?</h1>
                            </br></br>
                            <h3><i class="bi bi-question-circle" style="color: blue"></i> Pregunta 4/10</h3>
        ...
        <div class="d-grid gap-2 col-6 mx-auto">
            ...
            <br/>
            <a data-toggle="modal" data-target="#modal2" data-backdrop="static" data-keyboard="false"><button class="btn btn-primary btn-block btn-huge" style="font-size: 25px"><s:property value="numbers.numberCorrect"/></button></a>
            <br/>
        ...
        <jsp:include page="/WEB-INF/content/hard/multiplied/correct/correct4.jsp"/>
        <jsp:include page="/WEB-INF/content/hard/multiplied/incorrect/incorrect4.jsp"/>
