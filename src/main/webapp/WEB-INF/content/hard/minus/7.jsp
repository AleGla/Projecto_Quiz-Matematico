...
<html>
    <head>
        ...
        <title>Operaciones de Restas</title>
    ...
    <body>
        ...
        <jsp:include page="/WEB-INF/content/hard/minus/correct/correct7.jsp"/>
        <jsp:include page="/WEB-INF/content/hard/minus/incorrect/incorrect7.jsp"/>
