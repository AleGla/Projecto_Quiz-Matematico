...
<html>
    ...
    <body>
                ...
                <div class="container">
                    <div class="row align-items-start">
                        ...
                        <div class="col">
                            ...
                            <h3><i class="bi bi-question-circle" style="color: blue"></i> Pregunta 8/10</h3>
        ...
        <jsp:include page="/WEB-INF/content/easy/multiplied/correct/correct8.jsp"/>
        <jsp:include page="/WEB-INF/content/easy/multiplied/incorrect/incorrect8.jsp"/>
