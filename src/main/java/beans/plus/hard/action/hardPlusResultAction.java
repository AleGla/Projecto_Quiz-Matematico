...
@Result(name = "result", location = "/WEB-INF/content/hard/plus/resultFinal.jsp")

public class hardPlusResultAction extends ActionSupport {

    private Numbers numbers = new Numbers();
    String qualification = " ";

    @Action("resultFinalHCP")
    @Override
