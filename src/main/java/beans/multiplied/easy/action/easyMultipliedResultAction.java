...
@Result(name = "result", location = "/WEB-INF/content/easy/multiplied/resultFinal.jsp")
public class easyMultipliedResultAction extends ActionSupport {

    private Numbers numbers = new Numbers();
    String qualification = " ";

    @Action("resultFinalCMU")
    @Override
