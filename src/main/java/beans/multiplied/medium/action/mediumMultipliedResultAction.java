...
@Result(name = "result", location = "/WEB-INF/content/medium/multiplied/resultFinal.jsp")

public class mediumMultipliedResultAction extends ActionSupport {

    private Numbers numbers = new Numbers();
    String qualification = " ";

    @Action("resultFinalMCMU")
    @Override
