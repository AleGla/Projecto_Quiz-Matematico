...
@Result(name = "result", location = "/WEB-INF/content/hard/divided/resultFinal.jsp")

public class hardDividedResultAction extends ActionSupport {

    private Numbers numbers = new Numbers();
    String qualification = " ";

    @Action("resultFinalHCD")
    @Override
