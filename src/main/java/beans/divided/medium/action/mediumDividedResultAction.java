...
@Result(name = "result", location = "/WEB-INF/content/medium/divided/resultFinal.jsp")

public class mediumDividedResultAction extends ActionSupport {

    private Numbers numbers = new Numbers();
    String qualification = " ";

    @Action("resultFinalMCD")
    @Override
