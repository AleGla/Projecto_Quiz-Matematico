...
@Result(name = "result", location = "/WEB-INF/content/easy/divided/resultFinal.jsp")
public class easyDividedResultAction extends ActionSupport {

    private Numbers numbers = new Numbers();
    String qualification = " ";

    @Action("resultFinalCD")
    @Override
