...
@Result(name = "result", location = "/WEB-INF/content/hard/minus/resultFinal.jsp")

public class hardMinusResultAction extends ActionSupport {

    private Numbers numbers = new Numbers();
    String qualification = " ";

    @Action("resultFinalHCMI")
    @Override
