...
@Result(name = "result", location = "/WEB-INF/content/medium/minus/resultFinal.jsp")

public class mediumMinusResultAction extends ActionSupport {

    private Numbers numbers = new Numbers();
    String qualification = " ";

    @Action("resultFinalMCMI")
    @Override
