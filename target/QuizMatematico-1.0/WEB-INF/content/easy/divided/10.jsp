...
<html>
    ...
    <body>
        ...
        <jsp:include page="/WEB-INF/content/easy/divided/correct/correct10.jsp"/>
        <jsp:include page="/WEB-INF/content/easy/divided/incorrect/incorrect10.jsp"/>
