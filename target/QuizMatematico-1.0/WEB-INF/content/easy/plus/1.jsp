    ...
    <body>
        <header>
            ...
            <div class="row align-items-start">
                ...
                <h3><i class="bi bi-question-circle" style="color: blue"></i> Pregunta 1/10</h3>
        ...
        <jsp:include page="/WEB-INF/content/easy/plus/correct/correct.jsp"/>
        <jsp:include page="/WEB-INF/content/easy/plus/incorrect/incorrect.jsp"/>
    </body>
</html>
