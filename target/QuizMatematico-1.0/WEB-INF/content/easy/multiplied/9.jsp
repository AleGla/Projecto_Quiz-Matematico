...
<html>
    <head>
        ...
        <title>Operaciones de Multiplicacion</title>
    ...
    <body>
            ...
            <div class="jumbotron text-center" >
                <div class="container">
                    <div class="row align-items-start">
                        ...
                        <div class="col">
                            <h1 style="font-size: 60px"><s:property value="numbers.number"/> * <s:property value="numbers.numberTwo"/> = ?</h1>
                            </br></br>
                            <h3><i class="bi bi-question-circle" style="color: blue"></i> Pregunta 9/10</h3>
        ...
        <jsp:include page="/WEB-INF/content/easy/multiplied/correct/correct9.jsp"/>
        <jsp:include page="/WEB-INF/content/easy/multiplied/incorrect/incorrect9.jsp"/>
