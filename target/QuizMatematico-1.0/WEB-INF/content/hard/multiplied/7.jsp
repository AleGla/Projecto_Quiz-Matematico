...
<html>
    ...
    <body>
                ...
                <div class="container">
                    <div class="row align-items-start">
                        ...
                        <div class="col">
                            ...
                            <h3><i class="bi bi-question-circle" style="color: blue"></i> Pregunta 7/10</h3>
        ...
        <jsp:include page="/WEB-INF/content/hard/multiplied/correct/correct7.jsp"/>
        <jsp:include page="/WEB-INF/content/hard/multiplied/incorrect/incorrect7.jsp"/>
